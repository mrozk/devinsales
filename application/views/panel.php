...
<form role="form" id="insales-form" action="<?php echo (($user !== null)?'/admin/main/save/?id=' . $id :$base_url . 'cabinet/save/');?>" method="post">
    <div class="jumbotron">
        ...
        <p class="lead">
            ...
            просим связаться с клиентским отделом.
        </p>
    ...
    <div class="row marketing">
        <div class="col-lg-6">
            ...
            <h4>Текущий url сайта</h4>
            <p class="bg-success">Актуальный домен на котором работает приложение. Например: www.example.ru или example.ru</p>
            <p>
                <?php
                $attrs = array(
                ...
                echo Form::input('add_url', $add_url, $attrs);
                ?>
            </p>
